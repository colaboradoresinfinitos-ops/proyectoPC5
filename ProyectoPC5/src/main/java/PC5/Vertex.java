...
public class Vertex<T extends Comparable<T>> implements Comparable<Vertex<T>>{
    ...
    /**
     * Busca una arista que tenga como destino el vértice especificado.
     * Útil para verificar conexiones específicas en el grafo.
     * @param v Vértice destino a buscar
     * @return Arista que conecta this -> v, o null si no existe
     */
    public Edge<T> getEdge(Vertex<T> v){
        // Recorrer todas las aristas de este vértice
        for(Edge<T> e: edges){
            // Verificar si el vértice destino es el buscado
    ...
    /**
     * Elimina una arista específica de la lista de aristas.
     * @param edge Arista a eliminar
     * @return true si la arista existía y fue eliminada
     */
